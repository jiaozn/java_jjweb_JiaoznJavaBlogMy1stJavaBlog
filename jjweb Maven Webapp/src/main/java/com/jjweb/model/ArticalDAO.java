...
public class ArticalDAO extends HibernateDaoSupport{
	...
	public static final String CONTENT = "content";
		...
		public void save(Artical transientInstance) {
			log.debug("saving Artical instance");
			try {
		...
		public List<Artical> findByExample(Artical instance) {
			log.debug("finding Artical instance by example");
			try {
				List<Artical> results = (List<Artical>) getHibernateTemplate()
		...
		public List findByProperty(String propertyName, Object value) {
			log.debug("finding Artical instance with property: "
					+ propertyName + ", value: " + value);
			try {
				String queryString = "from Artical as model where model."
						+ propertyName + "= ?";
		...
		public List<Artical> findByContent(Object content) {
			return findByProperty(CONTENT, content);
		}

		public List findAll() {
			log.debug("finding all Artical instances");
			try {
		...
		public static ArticalDAO getFromApplicationContext(
				ApplicationContext ctx) {
			return (ArticalDAO) ctx.getBean("ArticalDAO");
		}
}
